...
HELP_16 = """
<b><u>AFK (ᴀᴡᴀʏ ғʀᴏᴍ ᴋᴇʏʙᴏᴀʀᴅ) :</b></u>

ʟᴇᴛ ᴏᴛʜᴇʀs ᴋɴᴏᴡ ʏᴏᴜ'ʀᴇ ᴀᴡᴀʏ. ʙᴏᴛ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ɴᴏᴛɪғʏ ᴜsᴇʀs ᴡʜᴏ ᴍᴇɴᴛɪᴏɴ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ʏᴏᴜ.

/afk : sᴇᴛ ʏᴏᴜʀsᴇʟғ ᴀs ᴀғᴋ.
/afk [ʀᴇᴀsᴏɴ] : sᴇᴛ ʏᴏᴜʀsᴇʟғ ᴀs ᴀғᴋ ᴡɪᴛʜ ᴀ ʀᴇᴀsᴏɴ.
/brb : sᴀᴍᴇ ᴀs /afk ᴄᴏᴍᴍᴀɴᴅ.

<b>ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ :</b>
• ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴘʜᴏᴛᴏ ᴡɪᴛʜ /afk ᴛᴏ sᴇᴛ ɪᴛ ᴀs ʏᴏᴜʀ ᴀғᴋ ɪᴍᴀɢᴇ
• ʀᴇᴘʟʏ ᴛᴏ ᴀ ɢɪғ ᴡɪᴛʜ /afk ᴛᴏ sᴇᴛ ɪᴛ ᴀs ʏᴏᴜʀ ᴀғᴋ ᴀɴɪᴍᴀᴛɪᴏɴ
• ʀᴇᴘʟʏ ᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ ᴡɪᴛʜ /afk ᴛᴏ ᴜsᴇ ɪᴛ ᴀs ᴀғᴋ ᴍᴇᴅɪᴀ

<b>ɴᴏᴛᴇ:</b> ᴀғᴋ sᴛᴀᴛᴜs ɪs ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ʀᴇᴍᴏᴠᴇᴅ ᴡʜᴇɴ ʏᴏᴜ sᴇɴᴅ ᴀɴʏ ᴍᴇssᴀɢᴇ.
"""

HELP_17 = """
<b><u>ᴛᴀɢᴀʟʟ / ᴍᴇɴᴛɪᴏɴ :</b></u> [sᴜᴅᴏᴇʀs ᴏɴʟʏ]

ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ.

/tagall : ᴍᴇɴᴛɪᴏɴ ᴡɪᴛʜ ʀᴀɴᴅᴏᴍ ᴍᴇssᴀɢᴇs.
/tagall [ᴛᴇxᴛ] : ᴍᴇɴᴛɪᴏɴ ᴡɪᴛʜ ᴄᴜsᴛᴏᴍ ᴍᴇssᴀɢᴇ.
/vctag : ᴍᴇɴᴛɪᴏɴ ғᴏʀ ᴠᴄ ɪɴᴠɪᴛᴀᴛɪᴏɴ.
/cancel : sᴛᴏᴘ ᴍᴇɴᴛɪᴏɴ ᴘʀᴏᴄᴇss.
"""

HELP_18 = """
<b><u>ᴡᴇʟᴄᴏᴍᴇ :</b></u> [ᴀᴅᴍɪɴs ᴏɴʟʏ]

ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇs ᴡɪᴛʜ ᴄᴜsᴛᴏᴍ ɪᴍᴀɢᴇ.

/welcome on : ᴇɴᴀʙʟᴇ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇs.
/welcome off : ᴅɪsᴀʙʟᴇ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇs.
"""
